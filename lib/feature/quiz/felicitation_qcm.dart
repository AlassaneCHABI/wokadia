...
class FelicitationQcm extends StatefulWidget {
  int score,totalQuestions,moduleId,totalTime;
   FelicitationQcm({super.key, required this.score,required this.totalQuestions,required this.moduleId,required this.totalTime});

  @override
  State<FelicitationQcm> createState() => _FelicitationQcmState();
}

class _FelicitationQcmState extends State<FelicitationQcm> {
...
@override
  void initState() {
    ...
    _getLocalUser();
    _loadElevesFromDb();
    DbManager().updateModuleScore(widget.moduleId, widget.score, widget.totalTime);
  }
      ...
      body: Padding(
        ...
        child: Column(
          children: [
              ...
              child: AnimatedSpeechBubble(
                child: AnimatedTextKit(
                  ...
                  animatedTexts: [
                    TyperAnimatedText(
                      "Félicitation !"
                          "Tu as terminé ton quiz."
                          "A présent tu "
                          "peux passer au suivant. ",
            ...
            Center(child:Text("${widget.score}/100",style:TextStyle(
              fontSize: 30,
              fontWeight: FontWeight.w600,
              color: Vert
            ),),),
            ...
            ConstrainedBox(
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () async {
                    //await DbManager().updateModuleScore(widget.moduleId, widget.score,widget.totalTime,);
